...
<section
    ...
    <div class="lg:px-16 px-5 py-20">
        <div class="flex flex-row h-[700px] border-l items-start">
            ...
            <div class="basis-1/2 px-6 sticky top-20">
                <!-- About text -->
                <div class="flex lg:flex-col">
                    <a href="" class="inline-flex">
                        <svg class="w-6 h-6 mr-5 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                ...
                <!-- About h1 text -->
                <div class="text-4xl text-white font-semibold my-10">
                    <h1>
