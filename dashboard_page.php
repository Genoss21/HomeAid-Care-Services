...
<div class="flex flex-row h-screen">
    ...
    <div class="basis-5/6">
        ...
        <div class="flex flex-wrap p-8 space-x-8">
            <button type="button"
                class="dashboard_add_buttons bg-[url('./Images/Add-Patient.jpg')] hover:bg-[url('./Images/Add-Patient.gif')]">
            ...
            <button type="button"
                class="dashboard_add_buttons bg-[url('./Images/Add-Doctors.jpg')] hover:bg-[url('./Images/Add-Doctors.gif')]">
                <div class="inline-flex absolute top-3 left-2">
                    <svg class="w-5 h-5 text-gray-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
                        height="24" fill="none" viewBox="0 0 24 24">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <button type="button"
                class="dashboard_add_buttons bg-[url('./Images/Add-Nurse.jpg')] hover:bg-[url('./Images/Add-Nurse.gif')]">
                <div class="inline-flex absolute top-3 left-2">
                    <svg class="w-5 h-5 text-gray-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
                        height="24" fill="none" viewBox="0 0 24 24">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
