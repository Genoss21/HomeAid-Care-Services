    ...
    <section class="lg:max-h mb-16 bg-[#505A63]">
        ...
        <div class="flex lg:flex-row flex-col px-5">
            <div class="basis-1/2 h-max-screen max-w-screen-xl lg:pt-24 lg:px-24 p-5">
                <h1 class="lg:text-6xl text-4xl tracking-tighter font-semibold text-white">Caring for comfort,
                    building for
                    peace.</h1>
            ...
            <div class="basis-1/2 h-max-screen max-w-screen-xl lg:pt-24 lg:px-24 p-5 text-white">
                ...
                <div class="pb-10">
                    <p class="lg:text-lg text-base">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                        Dolorum
                        aspernatur
                        officia ullam
                ...
                <div class="pb-10">
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita consequuntur quia placeat
                        saepe molestias, ratione inventore, impedit ipsam beatae soluta dignissimos hic eius cumque,
                        similique vel voluptatem aliquid nobis quas neque laborum ab voluptatum? Accusantium rerum
                        ipsa eveniet quasi hic quo aspernatur illo commodi. Labore ducimus mollitia non quas illum.
                    </p>
                </div>
            </div>
        </div>
        <div class="h-10 border-b-2 lg:mx-24 mx-10 border-gray-500"></div>
        <div class="flex lg:flex-row flex-col lg:px-5 p-5">
            <div class="basis-1/2 h-max-screen max-w-screen-xl lg:pt-24 lg:px-24 p-5">
                <h1 class="lg:text-6xl text-4xl tracking-tighter font-semibold text-white">We care for people, we
                    build for
                    comfort</h1>
            </div>
            <div class="basis-1/2 h-max-screen max-w-screen-xl lg:pt-24 lg:px-24 p-5 text-white">
