            ...
            <ul class="flex flex-col space-y-4 pt-2">
                <li>
                    <a href="dashboard_page.php" class="flex items-center p-3 rounded-lg hover:bg-gray-700 group">
                        <svg class="w-6 h-6 transition duration-75 group-hover:text-white" aria-hidden="true"
                        ...
                        <span class="ms-3 group-hover:text-white">Dashboard</span>
                    </a>
                </li>
                <li>
                    <button type="button"
                        ...
                        <span
                            class="flex-1 ms-3 text-white text-left rtl:text-right whitespace-nowrap group-hover:text-white">Users</span>
                        <svg class="w-3 h-3 group-hover:text-white text-white" aria-hidden="true"
                ...
                <li>
                    <button type="button"
                        ...
                        <svg class="w-3 h-3 group-hover:text-white" aria-hidden="true"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="m1 1 4 4 4-4" />
                        </svg>
