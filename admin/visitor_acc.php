                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody class="overflow-y-auto">
                        <tr
                            ...
                            <!-- Visitor Account ID Column -->
                            <td class="px-6 py-4">
                                000003
                            </td>

                            <!-- Username and Image Column -->
                            <th scope="row"
                                class="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                <img class="w-10 h-10 rounded-full" src="../assets/Images/user.jpg" alt="Visitor Image">
                                <div class="ps-3">
                            ...
                            <!-- Email Column -->
                            <td class="px-6 py-4">
                                fritztobes.visitor@hospitalcompany.com
                            </td>
