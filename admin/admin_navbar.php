...
<nav class="bg-gray-900 border-gray-200 text-white border-b-2">
    <div class="w-full flex items-center justify-between p-4">
        ...
        <div class="flex">
            <div class="p-2 text-gray-500"><svg class="w-7 h-7" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="flex items-center">
                    <div class="px-2">
                        <button type="button"
                            ...
                            <img class="w-10 h-10 rounded-full" src="../assets/Images/Fritz.jpg" alt="user photo">
                        </button>
                    </div>
