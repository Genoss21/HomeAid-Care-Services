      ...
      ">
        <div class="grid grid-cols-2 w-full h-full">
            <div class="justify-center p-16">
                <div class="basis-1/2 max-w-screen-xl lg:py-16">
                    <div class="border-l px-6">
                        <h1 class="mb-16 text-5xl tracking-tighter leading-none text-white md:text-5xl lg:text-6xl">
                            Welcome to [Your Company Name] Homecare Services
                        </h1>
                        <p class="mb-5 lg:pr-30 text-lg text-gray-300 lg:text-xl">
                            Your comfort and well-being are our top priorities. We provide compassionate, personalized
                            care
                            in the comfort of your own home, helping you or your loved ones live a happier, healthier
                            life.
                        </p>

                        <p class="mb-5 lg:pr-30 text-lg text-gray-300 lg:text-xl">
                            Whether you need daily support, post-surgery care, or companionship, our dedicated team is
                            here
                            to offer professional, reliable care you can trust.
                        </p>

                        <p class="mb-5 lg:pr-30 text-lg text-gray-300 lg:text-xl">
                            Explore our services and experience the difference of quality homecare today.onal, reliable
                            care
                            you can trust.
                        </p>
                        <!--View services-->
            ...
            <div class="p-16 z-10 w-full">
                <div class="max-w-md w-full space-y-8 mx-auto p-10 bg-white rounded-xl">
                    ...
                    <div class="flex flex-row justify-center items-center space-x-3">
                        <span
                            class="w-11 h-11 items-center justify-center inline-flex rounded-full font-bold text-lg text-white bg-blue-900 hover:shadow-lg cursor-pointer transition ease-in duration-300"><img
                                class="w-4 h-4"
                        ...
                        <span
                            class="w-11 h-11 items-center justify-center inline-flex rounded-full font-bold text-lg text-white bg-blue-400 hover:shadow-lg cursor-pointer transition ease-in duration-300"><img
                                class="w-4 h-4"
                        ...
                        <span
                            class="w-11 h-11 items-center justify-center inline-flex rounded-full font-bold text-lg text-white bg-blue-500 hover:shadow-lg cursor-pointer transition ease-in duration-300"><img
                    ...
                    <form class="mt-8 space-y-6" action="#" method="POST">
                        ...
                        <p class="flex flex-col items-center justify-center mt-10 text-center text-md text-gray-500">
                            ...
                            <a href="#"
                                class="text-indigo-500 hover:text-indigo-500no-underline hover:underline cursor-pointer transition ease-in duration-300">Sign
                                up</a>
                        </p>
                    </form>
                </div>
